...
*/
func (a *BooksAPIService) DeleteBook(ctx context.Context, id string) ApiDeleteBookRequest {
	return ApiDeleteBookRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *BooksAPIService) DeleteBookExecute(r ApiDeleteBookRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/books/{id}"
...
*/
func (a *BooksAPIService) GetBookById(ctx context.Context, id string) ApiGetBookByIdRequest {
	return ApiGetBookByIdRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *BooksAPIService) UpdateBook(ctx context.Context, id string) ApiUpdateBookRequest {
	return ApiUpdateBookRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
