...
*BooksAPI* | [**DeleteBook**](docs/BooksAPI.md#deletebook) | **Delete** /books/{id} | Delete a book by ID
*BooksAPI* | [**GetBookById**](docs/BooksAPI.md#getbookbyid) | **Get** /books/{id} | Get a book by ID
*BooksAPI* | [**ListBooks**](docs/BooksAPI.md#listbooks) | **Get** /books | List all books
*BooksAPI* | [**UpdateBook**](docs/BooksAPI.md#updatebook) | **Put** /books/{id} | Update a book by ID
